...
public class Planete extends Astre {
    ...
    private static final String[] IMAGES = {"/planetes/planete1.png", "/planetes/planete2.png", "/planetes/planete3.png", "/planetes/planete4.png", "/planetes/planete5.png", "/planetes/planete6.png", "/planetes/planete7.png", "/planetes/planete8.png",};
    ...
    public void draw(GraphicsContext contexte, double xEcran, double yEcran, double zoom, double largeur, double hauteur, double offsetX, double offsetY, double echelleAffichage) {
        ...
        contexte.drawImage(image, xEcran - w / 2, yEcran - h / 2, w, h);
